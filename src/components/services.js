        ...
        <div>
            <section className="bg-red-100 rounded-2xl p-5 mb-10">
                <div className="container mx-auto">
                    ...
                    <div className="flex flex-wrap pb-16 pb-28 justify-center">
                        <div className="w-full lg:w-1/2 xl:w-1/3 py-5 lg:p-5">
                            <div className="bg-white p-10 rounded-2xl shadow-lg">
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-16 w-16 mb-12 text-blue-600" fill="none"
                                ...
                                <p className="mt-3">
                                    Lorem ipsum dolor sit amet consectetur, adipisicing elit. Nisi ipsum similique reiciendis, delectus
                                    blanditiis amet quisquam possimus aspernatur. Temporibus accusamus voluptas numquam doloribus quae
                                    cupiditate? Perspiciatis numquam totam adipisci autem?
                                </p>
                            </div>
                        </div>
                        <div className="w-full lg:w-1/2 xl:w-1/3 py-5 lg:p-5">
                            <div className="bg-white p-10 rounded-2xl shadow-lg">
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-16 w-16 mb-12 text-red-600" fill="none" viewBox="0 0 24 24"
                                    stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <div className="w-full lg:w-1/2 xl:w-1/3 py-5 lg:p-5">
                            <div className="bg-white p-10 rounded-2xl shadow-lg">
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-16 w-16 mb-12 text-green-600" fill="none"
                                    viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
